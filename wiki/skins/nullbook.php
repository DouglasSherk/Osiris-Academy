 ...
 * @subpackage Skins
 */
class Skinnullbook extends SkinTemplate {
	/** Using nullbook. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'nullbook';
		$this->stylename = 'nullbook';
		$this->template  = 'nullbookTemplate';
	}
}
 ...
 * @subpackage Skins
 */
class nullbookTemplate extends QuickTemplate {
	/**
	 * Template filter callback for nullbook skin.
...
<?php		}
		...
		wfRunHooks( 'nullbookTemplateToolboxEnd', array( &$this ) );
?>
			</ul>
		</div>
	</div>
      ...
      <div id="footer">
		<table width = "100%">
			<tr><td width="5%" align="left" nowrap='nowrap'><?php if($this->data['copyrightico']) { ?><div id="f-copyrightico"><?php $this->html('copyrightico') ?></div><?php } ?></td>
				<td align="center">
	  <a href="http://www.ipbwiki.com/forums/index.php?showtopic=413">Skin by SamatJain</a>
